...
def pointInside(frame, rectangle, p):
    ...
    # if not rectangle.contains(p):
        ...
        cv2.putText(frame, "TRIGGER STIM", (10, frame.shape[0] // 10), cv2.FONT_HERSHEY_DUPLEX, 2.0, (118, 185, 0), 2)
        return "TRIGGER"
    ...
    # Draw green rectangle if rect contains point
        ...
        cv2.putText(frame, "BASE AMPLITUDE", (10, frame.shape[0] // 10), cv2.FONT_HERSHEY_DUPLEX, 2.0, (118, 185, 0), 2)
        return "NONE"
